...
function Customizados() {
  ...
  useEffect(() => {
    const readExcelFile = async () => {
      try {
        ...
        const filteredDocuments = jsonData.filter(document => document.Ámbito === 'Customizado');
  ...
  return (
    <div className="container">
      <h2>Customizados</h2>
      <p>Bienvenido a nuestra página "Customizados". Aquí puedes encontrar documentos personalizados para proyectos específicos de Idrica.</p>
