...
function Plantillas() {
  ...
  useEffect(() => {
    const readExcelFile = async () => {
      try {
        ...
        const filteredDocuments = jsonData.filter(document => document.Ámbito === 'Plantilla');
  ...
  return (
    <div className="container">
      <h2>Plantillas</h2>
      <p>Bienvenido a nuestra página "Plantillas". Aquí puedes encontrar documentos de plantillas para proyectos de Idrica.</p>
