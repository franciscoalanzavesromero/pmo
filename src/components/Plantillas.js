...
function Plantillas() {
  ...
  useEffect(() => {
    const readExcelFile = async () => {
      ...
      const plantillaData = jsonData.filter(item => item.Ámbito && item.Ámbito.toLowerCase().includes('plantilla'));
      setData(plantillaData);
      setFilteredData(plantillaData);
    };
